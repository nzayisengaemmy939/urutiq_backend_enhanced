...
export async function seedBankingIntegrationSimple({ tenantId, companyId }: { tenantId: string, companyId: string }) {
  console.log('🌱 Seeding simple banking integration data...')
  ...
  console.log('🎉 Simple banking integration seed data completed!')
  console.log(`📊 Summary:`)
