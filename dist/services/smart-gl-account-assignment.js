...
export class SmartGLAccountAssignment {
     ...
     */
    async assignOptimalGLAccount(options) {
        ...
        try {
            ...
            if (recommendedAccount) {
                ...
                const validation = await seniorAccountCodeManager.validateAccountUsage(recommendedAccount.code, usageContext, tenantId, companyId);
     ...
     */
    async getAccountByCategory(tenantId, companyId, categoryId) {
        ...
        for (const mapping of categoryMappings) {
            if (mapping.keywords.some(keyword => category.name.toLowerCase().includes(keyword) ||
     ...
     */
    async getAccountByDescription(tenantId, companyId, description) {
     ...
     */
    async getAccountByAmount(tenantId, companyId, amount) {
     ...
     */
    async getDefaultExpenseAccount(tenantId, companyId) {
     ...
     */
    async updateExpenseWithGLAccount(expenseId, accountId) {
        try {
