...
export class GoodReceiptPDFService {
     ...
     */
    async generateGoodReceiptPDF(receiptId, options = {}) {
        try {
            // Fetch receipt data
     ...
     */
    async generatePurchaseOrderReceiptPDF(purchaseOrderId, options = {}) {
        try {
...
<body>
     ...
     */
    async savePDFToFile(receiptId, filePath, options = {}) {
     ...
     */
    async getPDFAsBase64(receiptId, options = {}) {
        const pdfBuffer = await this.generateGoodReceiptPDF(receiptId, options);
