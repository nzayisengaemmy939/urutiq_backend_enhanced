...
export class PerformanceMonitoringService {
    ...
    static async getApiUsageAnalytics(tenantId, startDate, endDate, companyId) {
        const whereClause = {
            tenantId,
            timestamp: {
                gte: startDate,
    ...
    static async getPerformanceMetrics(tenantId, startDate, endDate, companyId) {
        const whereClause = {
            tenantId,
            timestamp: {
                gte: startDate,
    ...
    static async recordMetric(tenantId, metricName, metricValue, metricUnit, tags) {
        try {
    ...
    // Get custom metrics
    static async getCustomMetrics(tenantId, metricName, startDate, endDate) {
