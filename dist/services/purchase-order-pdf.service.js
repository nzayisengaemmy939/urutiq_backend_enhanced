...
export class PurchaseOrderPDFService {
     ...
     */
    async generatePurchaseOrderPDF(purchaseOrderId, options = {}) {
        try {
...
<body>
     ...
     */
    async savePDFToFile(purchaseOrderId, filePath, options = {}) {
     ...
     */
    async getPDFAsBase64(purchaseOrderId, options = {}) {
        const pdfBuffer = await this.generatePurchaseOrderPDF(purchaseOrderId, options);
