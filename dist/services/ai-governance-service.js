...
export class AIGovernanceService {
     ...
     */
    async getPolicies(tenantId, companyId, filters) {
        try {
            const where = {
                tenantId,
                companyId
     ...
     */
    async getPolicyById(policyId, tenantId, companyId) {
        try {
     ...
     */
    async updatePolicy(policyId, data, tenantId, companyId) {
        try {
     ...
     */
    async updateViolation(violationId, data, tenantId, companyId) {
        try {
     ...
     */
    async getViolations(tenantId, companyId, filters) {
        try {
            const where = {
                tenantId,
                companyId
     ...
     */
    async getExperiments(tenantId, companyId, filters) {
        try {
            const where = {
                tenantId,
                companyId
     ...
     */
    async getExperimentById(experimentId, tenantId, companyId) {
        try {
     ...
     */
    async updateExperiment(experimentId, data, tenantId, companyId) {
        try {
     ...
     */
    async getGovernanceStatistics(tenantId, companyId) {
        try {
            const [totalPolicies, activePolicies, totalViolations, openViolations, criticalViolations, totalExperiments, activeExperiments] = await Promise.all([
     ...
     */
    async deletePolicy(policyId, tenantId, companyId) {
        try {
     ...
     */
    async deleteExperiment(experimentId, tenantId, companyId) {
        try {
