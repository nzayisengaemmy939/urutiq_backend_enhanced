...
export function mountCollaborationRoutes(router) {
    // Client Portal Access
    router.get('/client-access', requireAuth, async (req, res) => {
    ...
    router.post('/client-access', requireAuth, validateBody(collaborationSchemas.clientAccessCreate), async (req, res) => {
        const { companyId, userId, permissions, isActive } = req.body;
    ...
    router.put('/client-access/:id', requireAuth, validateBody(collaborationSchemas.clientAccessUpdate), async (req, res) => {
        const { id } = req.params;
    ...
    router.delete('/client-access/:id', requireAuth, async (req, res) => {
        const { id } = req.params;
    ...
    router.get('/messages', requireAuth, async (req, res) => {
        ...
        if (conversationWith) {
            filteredMessages = messages.filter(m => m.senderId === conversationWith || m.receiverId === conversationWith);
        }
        res.json(filteredMessages);
    });
    router.post('/messages', requireAuth, validateBody(collaborationSchemas.messageCreate), async (req, res) => {
        const { companyId, receiverId, messageText } = req.body;
        try {
    ...
    router.put('/messages/:id', requireAuth, validateBody(collaborationSchemas.messageUpdate), async (req, res) => {
        const { id } = req.params;
        const updates = req.body;
    ...
    router.post('/tasks', requireAuth, validateBody(collaborationSchemas.taskCreate), async (req, res) => {
        const { companyId, assignedTo, taskType, title, description, dueDate, priority } = req.body;
    ...
    router.put('/tasks/:id', requireAuth, validateBody(collaborationSchemas.taskUpdate), async (req, res) => {
        const { id } = req.params;
        const updates = req.body;
    ...
    router.get('/tasks/overdue', requireAuth, async (req, res) => {
        const companyId = String(req.query.companyId || '');
        const where = {
            tenantId: req.tenantId,
            dueDate: { lt: new Date() },
    ...
    router.get('/company-users/:companyId', requireAuth, async (req, res) => {
