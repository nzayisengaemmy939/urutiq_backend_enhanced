...
export function mountAiRoutes(router) {
    ...
    // Anomalies
    router.get('/ai/anomalies', asyncHandler(async (req, res) => {
    ...
    router.post('/ai/anomalies', validateBody(aiSchemas.anomalyCreate), asyncHandler(async (req, res) => {
        const { companyId, transactionId, anomalyType, confidenceScore } = req.body;
    ...
    router.patch('/ai/anomalies/:id/status', validateBody(aiSchemas.anomalyUpdateStatus), asyncHandler(async (req, res) => {
        const { id } = req.params;
    ...
    router.post('/ai/anomalies/detect', asyncHandler(async (req, res) => {
    ...
    router.get('/ai/forecast', asyncHandler(async (req, res) => {
        const companyId = String(req.query.companyId || '');
    ...
    router.post('/ai/insights', validateBody(aiSchemas.insightCreate), asyncHandler(async (req, res) => {
        const { companyId, category, insightText, priority } = req.body;
    ...
    router.post('/ai/insights/generate', asyncHandler(async (req, res) => {
        const companyId = String(req.body?.companyId || req.query.companyId || '');
        if (!companyId)
            return res.status(400).json({ error: 'company_required' });
    ...
    // Predictions
    router.get('/ai/predictions', asyncHandler(async (req, res) => {
        const companyId = String(req.query.companyId || '');
    ...
    router.post('/ai/predictions', validateBody(aiSchemas.predictionCreate), asyncHandler(async (req, res) => {
        const { companyId, predictionType, predictedValue, predictionDate, confidenceLow, confidenceHigh } = req.body;
    ...
    router.post('/ai/predictions/generate', asyncHandler(async (req, res) => {
        const companyId = String(req.body?.companyId || req.query.companyId || '');
    ...
    router.post('/ai/recommendations', validateBody(aiSchemas.recommendationCreate), asyncHandler(async (req, res) => {
        const { companyId, recommendationType, recommendationText } = req.body;
    ...
    router.patch('/ai/recommendations/:id/status', validateBody(aiSchemas.recommendationUpdateStatus), asyncHandler(async (req, res) => {
        const { id } = req.params;
        const { status } = req.body;
    ...
    router.post('/ai/recommendations/generate', asyncHandler(async (req, res) => {
        const companyId = String(req.body?.companyId || req.query.companyId || '');
        if (!companyId)
            return res.status(400).json({ error: 'company_required' });
    ...
    // Audit trail
    router.get('/ai/audit-trails', asyncHandler(async (req, res) => {
        const companyId = String(req.query.companyId || '');
    ...
    router.post('/ai/audit-trails', validateBody(aiSchemas.auditAppend), asyncHandler(async (req, res) => {
        const { companyId, userId, action, aiValidationResult } = req.body;
    ...
    router.post('/ai/feedback/anomaly/:id', asyncHandler(async (req, res) => {
        const { id } = req.params;
        const { verdict, userId } = req.body; // verdict: 'true_positive' | 'false_positive'
    ...
    router.post('/ai/feedback/insight/:id', asyncHandler(async (req, res) => {
        const { id } = req.params;
        const { action, userId } = req.body; // action: 'acknowledge' | 'dismiss'
    ...
    router.post('/ai/generate/all', asyncHandler(async (req, res) => {
        const companyId = String(req.body?.companyId || req.query.companyId || '');
        if (!companyId)
            return res.status(400).json({ error: 'company_required' });
    ...
    router.get('/insights', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), asyncHandler(async (req, res) => {
