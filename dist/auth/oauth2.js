...
export const oauth2Middleware = (requiredScopes) => {
...
export class PKCE {
    ...
    static generateCodeChallenge(verifier, method = 'S256') {
        if (method === 'S256') {
            return crypto.createHash('sha256').update(verifier).digest('base64url');
        }
        return verifier;
    }
    static verifyCodeChallenge(verifier, challenge, method = 'S256') {
