...
router.post('/conversational/chat', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
...
router.post('/documents/process-receipt', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
...
router.post('/documents/process-upload', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
...
router.post('/documents/process-invoice', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
...
router.post('/documents/process-contract', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
    const { documentContent, companyId } = req.body;
    const { tenantId } = req;
    const userId = req.user?.sub || 'demo-user-1';
    if (!documentContent || !companyId) {
...
router.post('/analytics/cash-flow-forecast', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
...
router.post('/analytics/revenue-forecast', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
    const { companyId, months = 12 } = req.body;
    const { tenantId } = req;
    const userId = req.user?.sub || 'demo-user-1';
    if (!companyId) {
...
router.post('/analytics/expense-forecast', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
    const { companyId, months = 12 } = req.body;
    const { tenantId } = req;
    const userId = req.user?.sub || 'demo-user-1';
    if (!companyId) {
...
router.post('/analytics/comprehensive-forecast', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
    const { companyId, months = 12 } = req.body;
    const { tenantId } = req;
    const userId = req.user?.sub || 'demo-user-1';
    if (!companyId) {
...
// Financial Analysis
router.post('/analysis/financial-trends', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
...
router.post('/analysis/financial-insights', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
    const { companyId } = req.body;
    const { tenantId } = req;
    const userId = req.user?.sub || 'demo-user-1';
    if (!companyId) {
...
// Document Query
router.post('/documents/query', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant', 'viewer']), asyncHandler(async (req, res) => {
...
router.post('/compliance/analyze', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
    const { companyId } = req.body;
    const { tenantId } = req;
    const userId = req.user?.sub || 'demo-user-1';
    if (!companyId) {
...
router.post('/compliance/audit-transaction', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
...
router.post('/compliance/generate-report', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), requireRoles(['admin', 'accountant']), asyncHandler(async (req, res) => {
...
async function buildLlamaConversationContext(companyId, tenantId, userId, sessionId) {
    try {
