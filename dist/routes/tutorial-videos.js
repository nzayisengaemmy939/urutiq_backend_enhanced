...
router.post('/test-upload', upload.single('video'), asyncHandler(async (req, res, next) => {
 ...
 */
router.post('/upload', requireRoles(['admin', 'accountant', 'auditor', 'employee']), upload.single('video'), asyncHandler(async (req, res, next) => {
    const tenantId = req.tenantId;
 ...
 */
router.get('/stream/:videoId', asyncHandler(async (req, res, next) => {
    ...
    const companyId = req.headers['x-company-id'] || req.query.companyId || 'cmg0qxjh9003nao3ftbaz1oc1';
 ...
 */
router.get('/:videoId', requireRoles(['admin', 'accountant', 'auditor', 'employee']), asyncHandler(async (req, res, next) => {
    const tenantId = req.tenantId;
    const videoId = req.params.videoId;
    try {
 ...
 */
router.post('/:videoId/rate', requireRoles(['admin', 'accountant', 'auditor', 'employee']), asyncHandler(async (req, res, next) => {
    const tenantId = req.tenantId;
    const videoId = req.params.videoId;
    const userId = req.user?.sub;
 ...
 */
router.post('/:videoId/view', requireRoles(['admin', 'accountant', 'auditor', 'employee']), asyncHandler(async (req, res, next) => {
    const tenantId = req.tenantId;
    const videoId = req.params.videoId;
    const userId = req.user?.sub;
 ...
 */
router.delete('/:videoId', requireRoles(['admin', 'accountant', 'auditor', 'employee']), asyncHandler(async (req, res, next) => {
    const tenantId = req.tenantId;
    const videoId = req.params.videoId;
    try {
