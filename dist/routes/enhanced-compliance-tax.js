...
router.get('/tax/calculations/:companyId', asyncHandler(async (req, res) => {
...
router.get('/tax/calculations/:companyId/:calculationId', asyncHandler(async (req, res) => {
...
router.get('/compliance/checks/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
...
router.get('/compliance/summary/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
...
router.post('/tax/filing/prepare', asyncHandler(async (req, res) => {
...
router.get('/tax/filings/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
...
// Submit tax filing
router.post('/tax/filings/:filingId/submit', asyncHandler(async (req, res) => {
...
router.get('/jurisdictions/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
    if (!companyId) {
        return res.status(400).json({ error: 'Company ID is required' });
    }
...
// Currency Conversion
router.post('/currency/convert', asyncHandler(async (req, res) => {
    ...
    try {
        const convertedAmount = await enhancedComplianceTaxService.convertCurrency(amount, fromCurrency, toCurrency, date ? new Date(date) : new Date());
        res.json({
            success: true,
            data: {
...
router.get('/tax/optimization/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
    ...
    try {
        ...
        const recommendations = await enhancedComplianceTaxService.getTaxOptimizationRecommendations(companyId, period);
        res.json({
            success: true,
            data: {
                period,
...
router.get('/tax/rates/:jurisdiction', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        let filteredRates = jurisdictionRates;
        if (taxType) {
            filteredRates = { [taxType]: jurisdictionRates[taxType] };
        }
        res.json({
            success: true,
            data: {
...
router.get('/filing/deadlines/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
...
// Get audit trail
router.get('/audit/trail/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
...
router.get('/compliance/rules/:companyId', asyncHandler(async (req, res) => {
    const { companyId } = req.params;
