...
export function mountSalesAccountingRoutes(router) {
     ...
     */
    router.post('/process-payment/:invoiceId', async (req, res) => {
        try {
     ...
     */
    router.get('/invoice/:invoiceId/entries', async (req, res) => {
        try {
            const { invoiceId } = req.params;
            const { tenantId } = req;
            if (!tenantId) {
     ...
     */
    router.get('/invoice/:invoiceId/inventory-movements', async (req, res) => {
        try {
            const { invoiceId } = req.params;
            const { tenantId } = req;
            if (!tenantId) {
