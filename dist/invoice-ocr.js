...
export class InvoiceOCRService {
     ...
     */
    static async processInvoiceDocument(tenantId, fileBuffer, fileName, mimeType) {
        try {
     ...
     */
    static async createInvoiceFromOCR(tenantId, companyId, customerId, ocrResult, additionalData) {
        try {
     ...
     */
    static async matchExpensesToInvoice(tenantId, invoiceId) {
        try {
     ...
     */
    static async applyExpenseMatches(tenantId, invoiceId, matches) {
        try {
     ...
     */
    static async simulateInvoiceProcessing(fileBuffer, fileName) {
     ...
     */
    static async calculateExpenseMatch(invoice, expense) {
        let confidence = 0;
        let reason = '';
        let suggestedAction = '';
