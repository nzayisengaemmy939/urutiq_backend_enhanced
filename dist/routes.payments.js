...
router.get('/payments', requireRoles(['admin', 'accountant', 'manager']), async (req, res) => {
    try {
...
router.get('/payments/bill/:billId', requireRoles(['admin', 'accountant', 'manager']), async (req, res) => {
    try {
