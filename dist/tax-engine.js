...
export class TaxJurisdictionService {
    ...
    static async getAll(tenantId, companyId) {
    ...
    static async getByCountry(tenantId, companyId, country) {
        return await prisma.$queryRaw `
    ...
    static async delete(id, tenantId, companyId) {
...
export class TaxRateService {
    ...
    static async getActive(tenantId, companyId, date) {
    ...
    static async getByJurisdiction(tenantId, companyId, jurisdictionId) {
        return await prisma.$queryRaw `
      SELECT * FROM TaxRate
...
export class TaxCalculationService {
    static async calculateTax(tenantId, companyId, data) {
      ...
      `;
        ...
        for (const taxRate of taxRates) {
            const calculation = await this.calculateSingleTax(tenantId, companyId, taxRate, cumulativeBase, exemptions || []);
    ...
    static async calculateSingleTax(tenantId, companyId, taxRate, baseAmount, exemptions) {
    ...
    static async getCalculationHistory(tenantId, companyId, filters = {}) {
        let query = `
    ...
    static async getTaxSummary(tenantId, companyId, fromDate, toDate) {
...
export class TaxConfigurationService {
    static async getOrCreate(tenantId, companyId) {
    ...
    static async update(tenantId, companyId, data) {
