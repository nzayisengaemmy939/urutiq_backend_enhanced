...
export function mountAccountingOverviewRoutes(router) {
    ...
    router.get('/overview', async (req, res) => {
        ...
        try {
            ...
            const assetAccounts = accountBalances.filter(acc => acc.accountType.toLowerCase().includes('asset') ||
            ...
            const revenueAccounts = accountBalances.filter(acc => acc.accountType.toLowerCase().includes('revenue') ||
                acc.accountType.toLowerCase().includes('income') ||
                acc.accountType.toLowerCase().includes('sales'));
            const expenseAccounts = accountBalances.filter(acc => acc.accountType.toLowerCase().includes('expense') ||
