...
// Template Management
router.get('/custom-report-builder/:companyId/templates', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
...
router.post('/custom-report-builder/:companyId/templates', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
...
// Data Sources
router.get('/custom-report-builder/:companyId/data-sources', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
...
// Custom Reports
router.get('/custom-report-builder/:companyId/reports', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
...
router.post('/custom-report-builder/:companyId/reports', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
...
// Report Generation
router.post('/custom-report-builder/:companyId/reports/:reportId/generate', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
...
// Report Export
router.post('/custom-report-builder/:companyId/reports/:reportId/export', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { reportId } = req.params
...
// Report Validation
router.post('/custom-report-builder/:companyId/validate', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
