...
router.get('/tax-calculation/:companyId/jurisdictions', auth, tenant, async (req, res) => {
  try {
    ...
    const jurisdictions = await taxCalculationService.getJurisdictions(
      companyId,
      taxType as string
    )
...
router.post('/tax-calculation/:companyId/calculate-multi', auth, tenant, async (req, res) => {
  try {
    ...
    const results = await taxCalculationService.calculateMultiJurisdictionTax(
      companyId,
      calculations,
      period
    )
...
router.get('/tax-calculation/:companyId/forms', auth, tenant, async (req, res) => {
  try {
    ...
    const forms = await taxCalculationService.getTaxForms(
      companyId,
      taxType as string,
...
router.post('/tax-calculation/:companyId/forms/generate', auth, tenant, async (req, res) => {
  try {
    ...
    const form = await taxCalculationService.generateTaxForm(
      companyId,
      formId,
      period,
      data
...
router.get('/tax-calculation/:companyId/returns', auth, tenant, async (req, res) => {
  try {
    ...
    const returns = await taxCalculationService.getTaxReturns(
      companyId,
      status as string
    )
...
router.post('/tax-calculation/:companyId/returns', auth, tenant, async (req, res) => {
  try {
    ...
    const taxReturn = await taxCalculationService.createTaxReturn(
      companyId,
      formId,
      period,
      data
...
router.get('/tax-calculation/:companyId/calendar', auth, tenant, async (req, res) => {
  try {
    ...
    const calendar = await taxCalculationService.getTaxCalendar(
      companyId,
...
router.post('/tax-calculation/:companyId/seed-ledger', auth, tenant, async (req, res) => {
  try {
    const { companyId } = req.params
    const tenantId = (req as any).tenantId || 'tenant_demo'
