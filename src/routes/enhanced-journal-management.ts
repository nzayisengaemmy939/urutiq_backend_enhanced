...
router.post('/create', asyncHandler(async (req: TenantRequest, res: any) => {
  ...
  try {
    const journalEntryRequest = await enhancedJournalManagementService.generateJournalEntry(
      description,
      finalAmount,
      companyId,
      context,
...
router.post('/manual', asyncHandler(async (req: TenantRequest, res: any) => {
...
// Post journal entry
router.post('/post/:id', asyncHandler(async (req: TenantRequest, res: any) => {
  const { id } = req.params;
  ...
  try {
    const journalEntry = await enhancedJournalManagementService.postJournalEntry(
      id,
...
// Void journal entry
router.post('/void/:id', asyncHandler(async (req: TenantRequest, res: any) => {
  const { id } = req.params;
  ...
  try {
    const journalEntry = await enhancedJournalManagementService.voidJournalEntry(
      id,
...
router.get('/entry/:id', asyncHandler(async (req: TenantRequest, res: any) => {
  const { id } = req.params;
...
router.get('/entries/:companyId', asyncHandler(async (req: TenantRequest, res: any) => {
  ...
  try {
    ...
    const journalEntries = await enhancedJournalManagementService.getJournalEntries(
      companyId,
      start,
      end,
      status as 'draft' | 'posted' | 'voided'
    );
...
router.post('/account-suggestions', asyncHandler(async (req: TenantRequest, res: any) => {
  const { description, amount, context, companyId } = req.body;
  const { tenantId } = req;
  ...
  try {
    ...
    const suggestions = await enhancedJournalManagementService.getDefaultAccountSuggestions(
      description,
      amount,
      companyId,
      tenantId || 'tenant_demo'
...
router.post('/validate', asyncHandler(async (req: TenantRequest, res: any) => {
...
// Get ledger balances
router.get('/ledger-balances/:companyId', asyncHandler(async (req: TenantRequest, res: any) => {
  const { companyId } = req.params;
...
// Detect anomalies
router.get('/anomalies/:companyId', asyncHandler(async (req: TenantRequest, res: any) => {
  const { companyId } = req.params;
  ...
  try {
    const anomalies = await enhancedJournalManagementService.detectAnomalies(
      companyId,
...
router.get('/chart-of-accounts/:companyId', asyncHandler(async (req: TenantRequest, res: any) => {
  const { companyId } = req.params;
...
// Create account
router.post('/accounts', asyncHandler(async (req: TenantRequest, res: any) => {
...
// Update account
router.put('/accounts/:id', asyncHandler(async (req: TenantRequest, res: any) => {
  const { id } = req.params;
  const { name, code, typeId, parentId, isActive } = req.body;
...
// Get account details
router.get('/accounts/:id', asyncHandler(async (req: TenantRequest, res: any) => {
  const { id } = req.params;
...
router.post('/batch-post', asyncHandler(async (req: TenantRequest, res: any) => {
...
router.get('/audit-trail/:entryId', asyncHandler(async (req: TenantRequest, res: any) => {
