...
router.get('/fixed-assets/:companyId/categories', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
  res.json({ items: await fixedAssetsService.listCategories(req.params.companyId) })
}))

router.post('/fixed-assets/:companyId/categories', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
...
router.get('/fixed-assets/:companyId/assets', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
  res.json({ items: await fixedAssetsService.listAssets(req.params.companyId) })
}))

router.post('/fixed-assets/:companyId/assets', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
...
router.delete('/fixed-assets/:companyId/assets/:id', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
  res.json(await fixedAssetsService.deleteAsset(req.params.id))
}))

router.get('/fixed-assets/:companyId/depreciation/preview', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
...
router.post('/fixed-assets/:companyId/depreciation/post', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
...
router.post('/fixed-assets/:companyId/assets/:id/dispose', authMiddleware(process.env.JWT_SECRET || 'dev-secret'), tenantMiddleware(), requireRoles(['accountant','admin']), asyncHandler(async (req: TenantRequest, res: any) => {
