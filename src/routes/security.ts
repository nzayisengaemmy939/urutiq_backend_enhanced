 ...
 */
async function getLocationFromIP(ipAddress: string | null | undefined): Promise<string> {
 ...
 */
router.get('/overview', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
 ...
 */
router.get('/access-control', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.get('/audit-logs', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.get('/compliance', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.get('/encryption', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.get('/monitoring', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.post('/settings', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
 ...
 */
router.get('/mfa/status', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.post('/mfa/setup/start', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.post('/mfa/setup/verify', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.post('/mfa/disable', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.post('/mfa/backup/regenerate', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.get('/sessions', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.delete('/sessions/:sessionId', requireAuth, asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.get('/ip-whitelist', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.post('/ip-whitelist', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.delete('/ip-whitelist/:id', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.get('/api-keys', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
 ...
 */
router.post('/api-keys', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.delete('/api-keys/:id', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
  const userId = req.user?.sub;
 ...
 */
router.post('/audit', requireAuth, requireRoles(['admin']), asyncHandler(async (req: TenantRequest, res: Response) => {
  const tenantId = req.tenantId!;
...
// Helper functions
function getActionStatus(action: string): string {
  ...
  if (failedActions.includes(action)) return 'failed';
  if (warningActions.includes(action)) return 'warning';
  return 'success';
}

function getSeverityLevel(action: string): string {
