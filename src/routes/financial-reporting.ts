...
// Balance Sheet
router.get('/financial-reporting/:companyId/balance-sheet', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
...
// Income Statement
router.get('/financial-reporting/:companyId/income-statement', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
    const { period, previousPeriod } = periodSchema.parse(req.query)
...
// Cash Flow Statement
router.get('/financial-reporting/:companyId/cash-flow', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
    const { period, previousPeriod } = periodSchema.parse(req.query)
...
// Financial Ratios
router.get('/financial-reporting/:companyId/ratios', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
...
router.get('/financial-reporting/:companyId/statements', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
    const { period, previousPeriod } = periodSchema.parse(req.query)
...
router.post('/financial-reporting/:companyId/export', authMiddleware, tenantMiddleware, async (req: any, res: any) => {
  try {
    const { companyId } = req.params
