...
router.get('/period-close/:companyId/periods',
...
router.post('/period-close/:companyId/:period/lock',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
...
router.post('/period-close/:companyId/:period/unlock',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/complete',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/adjustments/prior-period',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
    ...
    const out = await periodCloseService.postPriorPeriodAdjustment(
      req.tenantId!,
      companyId,
      period,
      {
...
router.get('/period-close/:companyId/:period/checklist',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.put('/period-close/:companyId/:period/checklist/:itemId',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
...
router.post('/period-close/:companyId/:period/run/recurring',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/run/allocations',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/run/fx-reval',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.get('/period-close/:companyId/:period/runs',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
    const type = String(req.query.type || '') || undefined as any;
    const items = await periodCloseService.listRuns(companyId, period, type as any);
    res.json({ success: true, data: items });
  })
);

// Additional routes needed by the frontend
router.get('/period-close/:companyId/:period/fx-preview',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.get('/period-close/:companyId/:period/fx-history',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/rollback',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/fx-reval/preview',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/fx-reval/post',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.get('/period-close/:companyId/:period/fx-reval/history',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
...
router.post('/period-close/:companyId/:period/fx-reval/post-journal',
  authMiddleware(process.env.JWT_SECRET || 'dev-secret'),
  requireRoles(['admin', 'accountant']),
  asyncHandler(async (req: TenantRequest, res: any) => {
    const { companyId, period } = req.params;
