...
export class CronService {
   ...
   */
  static async runTenantJobs(tenantId: string): Promise<void> {
   ...
   */
  static async generateRecurringInvoice(recurring: any): Promise<void> {
    try {
   ...
   */
  private static calculateNextRunDate(currentDate: Date, frequency: string, interval: number, options: any = {}): Date {
    const { AdvancedSchedulingService } = require('./services/advanced-scheduling.service')
   ...
   * Calculate due date
   */
  private static calculateDueDate(issueDate: Date, paymentTerms: number): Date {
   ...
   * Clean up old notifications
   */
  static async cleanupOldNotifications(tenantId: string): Promise<void> {
    try {
   ...
   * Update invoice statuses
   */
  static async updateInvoiceStatuses(tenantId: string): Promise<void> {
    try {
   ...
   */
  static async runWeeklyTenantJobs(tenantId: string): Promise<void> {
   ...
   */
  static async generateWeeklyReports(tenantId: string): Promise<void> {
    try {
   ...
   * Archive old data
   */
  static async archiveOldData(tenantId: string): Promise<void> {
    try {
