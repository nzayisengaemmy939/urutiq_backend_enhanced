...
router.get('/entries', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
  ...
  // Get journal summary
  router.get('/summary', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
    const companyId = req.header('x-company-id') || String(req.query.companyId || '');
  ...
  router.get('/entry-types', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
    const companyId = req.header('x-company-id') || String(req.query.companyId || '');
  ...
  router.get('/pending-approvals', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
    const companyId = req.header('x-company-id') || String(req.query.companyId || '');
  ...
  // Get journal metrics
  router.get('/metrics', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
    const companyId = req.header('x-company-id') || String(req.query.companyId || '');
  ...
  router.get('/permissions/:userId', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
    const companyId = req.header('x-company-id') || String(req.query.companyId || '');
  ...
  router.post('/entries', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
  ...
  router.post('/entries/:id/post', requireRoles(['admin', 'accountant']), async (req: TenantRequest, res) => {
    const { id } = req.params;
