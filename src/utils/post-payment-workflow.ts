 ...
 */
export async function processPostPaymentWorkflow(
  tenantId: string,
  companyId: string,
  paymentId: string
): Promise<{
  ...
  try {
    ...
    const updatedPOs = await updateRelatedPurchaseOrders(
      tenantId,
      companyId,
      bill,
      payment
 ...
 */
async function updateRelatedPurchaseOrders(
  tenantId: string,
  companyId: string,
  bill: any,
  payment: any
 ...
 */
async function updateVendorPaymentHistory(
  tenantId: string,
  companyId: string,
  vendorId: string,
  payment: any
 ...
 */
async function generatePaymentConfirmation(
  tenantId: string,
  companyId: string,
  payment: any
): Promise<any> {
