...
export async function seedBudgetManagementData(companyId: string) {
...
async function seedDimensions(companyId: string) {
...
async function seedScenarios(companyId: string) {
  const scenariosData = [
    {
...
async function seedPeriods(companyId: string) {
  const periodsData = [
    {
...
async function seedBudgetAccounts(companyId: string) {
  const accountsData = [
    {
...
async function seedBudgets(companyId: string, scenarioId: string, periodId: string) {
  const budgetsData = [
    {
...
async function seedBudgetLineItems(budgetId: string, accounts: any[], dimensions: any[]) {
  const lineItemsData = [
    {
      id: `line-${budgetId}-1`,
      budgetId,
...
async function seedRollingForecasts(companyId: string) {
  const forecastsData = [
    {
