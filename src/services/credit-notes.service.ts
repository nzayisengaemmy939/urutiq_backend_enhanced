...
export class CreditNotesService {
  async create(tenantId: string, companyId: string, body: CreateCreditNoteInput, userId?: string) {
    try {
  ...
  async update(tenantId: string, id: string, data: Partial<CreateCreditNoteInput>) {
    try {
