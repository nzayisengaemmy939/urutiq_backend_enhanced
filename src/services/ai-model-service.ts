...
export class AIModelService {
   ...
   */
  async getModels(tenantId: string, companyId: string, filters?: {
    status?: string;
    modelType?: string;
    algorithm?: string;
  }) {
    try {
      ...
      if (filters?.algorithm) where.algorithm = filters.algorithm;
   ...
   */
  async getModelById(modelId: string, tenantId: string, companyId: string) {
    try {
   ...
   * Update a model
   */
  async updateModel(modelId: string, data: UpdateAIModelRequest, tenantId: string, companyId: string) {
    try {
   ...
   */
  async createTrainingRun(data: CreateTrainingRunRequest) {
    try {
   ...
   * Create a prediction
   */
  async createPrediction(data: CreatePredictionRequest) {
    try {
   ...
   */
  async getPredictions(modelId: string, tenantId: string, companyId: string, limit = 100) {
    try {
   ...
   */
  async createPerformanceMetrics(data: PerformanceMetricsRequest) {
    try {
   ...
   */
  async getPerformanceMetrics(modelId: string, tenantId: string, companyId: string, days = 30) {
    try {
   ...
   */
  async getModelStatistics(tenantId: string, companyId: string) {
    try {
      const [
        totalModels,
        activeModels,
   ...
   */
  async deleteModel(modelId: string, tenantId: string, companyId: string) {
    try {
