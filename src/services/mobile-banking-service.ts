...
export interface MobileBankingStats {
  totalBalance: number
...
export interface MobileInsight {
  id: string
  type: 'spending' | 'saving' | 'income' | 'budget'
  title: string
  description: string
  value: number
...
export class MobileBankingService {
   ...
   */
  static async getMobileTransactions(
    tenantId: string,
    companyId: string,
    limit: number = 20
   ...
   */
  static async getMobileAccounts(
    tenantId: string,
    companyId: string
   ...
   */
  static async getMobileInsights(
    tenantId: string,
    companyId: string
  ): Promise<MobileInsight[]> {
   ...
   */
  private static getBudgetForCategory(category: string): number {
