...
export class RecurringEmailService {
   ...
   */
  async sendRecurringInvoiceGenerated(
   ...
   */
  async sendRecurringInvoiceReminder(
    recurring: RecurringInvoice,
    generatedInvoice: any,
    customer: any,
    daysUntilDue: number
   ...
   */
  async sendRecurringInvoiceSkipped(
    recurring: RecurringInvoice,
    customer: any,
    reason: string
  ): Promise<void> {
   ...
   */
  async sendRecurringInvoiceStatusChange(
    recurring: RecurringInvoice,
    customer: any,
    oldStatus: string,
    newStatus: string
   ...
   */
  private generateInvoiceGeneratedTemplate(data: {
    recurring: RecurringInvoice;
    generatedInvoice: any;
    customer: any;
    subject: string;
   ...
   */
  private generateReminderTemplate(data: {
    recurring: RecurringInvoice;
    generatedInvoice: any;
    customer: any;
    daysUntilDue: number;
   ...
   */
  private generateSkippedTemplate(data: {
    recurring: RecurringInvoice;
    customer: any;
    reason: string;
    subject: string;
   ...
   */
  private generateStatusChangeTemplate(data: {
    recurring: RecurringInvoice;
    customer: any;
    oldStatus: string;
    newStatus: string;
   ...
   */
  private parseEmailList(emailListJson: string | null): string[] {
    if (!emailListJson) return [];
    try {
