...
export interface ExpenseJournalIntegrationOptions {
  tenantId: string;
  companyId: string;
  expenseId: string;
...
export class ExpenseJournalIntegration {
   ...
   */
  async integrateExpenseWithJournal(options: ExpenseJournalIntegrationOptions) {
   ...
   */
  private async createExpenseJournalEntry(expense: any, tenantId: string, companyId: string, userId?: string) {
   ...
   */
  private async updateExpenseJournalEntry(expense: any, tenantId: string, companyId: string, userId?: string) {
   ...
   */
  private async approveExpenseJournalEntry(expense: any, tenantId: string, companyId: string, userId?: string) {
   ...
   */
  private async rejectExpenseJournalEntry(expense: any, tenantId: string, companyId: string, userId?: string) {
    const existingEntry = await this.prisma.journalEntry.findFirst({
      where: {
        tenantId,
        companyId,
   ...
   */
  private async deleteExpenseJournalEntry(expense: any, tenantId: string, companyId: string, userId?: string) {
    const existingEntry = await this.prisma.journalEntry.findFirst({
      where: {
        tenantId,
        companyId,
   ...
   */
  private generateExpenseReference(expense: any): string {
   ...
   */
  private async buildJournalEntryData(expense: any, tenantId: string, companyId: string, action: string): Promise<JournalEntryData | null> {
   ...
   */
  private async buildJournalLines(expense: any, expenseAccount: any, offsetAccount: any, tenantId: string, companyId: string) {
    const lines = [];
   ...
   * Get or create expense journal entry type
   */
  private async getOrCreateExpenseEntryType(tenantId: string, companyId: string) {
   ...
   */
  private async getOffsetAccount(expense: any, tenantId: string, companyId: string) {
   ...
   */
  private async findAccountByCode(tenantId: string, companyId: string, code: string) {
   ...
   */
  private async findAccountByType(tenantId: string, companyId: string, typeCode: string, namePattern: string) {
   ...
   */
  private async findAnyLiabilityAccount(tenantId: string, companyId: string) {
   ...
   */
  private async findAnyAssetAccount(tenantId: string, companyId: string) {
   ...
   * Post journal entry
   */
  private async postJournalEntry(entryId: string, tenantId: string, companyId: string, userId?: string) {
   ...
   * Create reversal entry
   */
  private async createReversalEntry(originalEntry: any, tenantId: string, companyId: string, userId?: string) {
    ...
    const reversalEntry = await this.prisma.journalEntry.create({
      data: {
        ...
        createdById: userId,
        lines: {
          create: reversalLines.map((line: any) => ({
            tenantId,
            accountId: line.accountId,
            debit: line.debit,
            credit: line.credit,
   ...
   */
  private async createReversalAndNewEntry(expense: any, existingEntry: any, tenantId: string, companyId: string, userId?: string) {
    // Create reversal
    await this.createReversalEntry(existingEntry, tenantId, companyId, userId);
