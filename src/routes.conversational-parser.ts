...
export function mountConversationalParserRoutes(router: Router) {
  ...
  router.post('/parser/test', asyncHandler(async (req: Request, res: Response) => {
  ...
  router.post('/parser/parse', asyncHandler(async (req: TenantRequest, res: Response) => {
    const { text, companyId } = req.body;
    const { tenantId } = req;
  ...
  router.post('/parser/create-entry', asyncHandler(async (req: TenantRequest, res: Response) => {
    ...
    if (autoCreate && parsed.confidence >= 70) {
      try {
        const result = await conversationalParser.createJournalEntry(
  ...
  router.post('/parser/batch-parse', asyncHandler(async (req: TenantRequest, res: Response) => {
  ...
  router.post('/parser/suggestions', asyncHandler(async (req: TenantRequest, res: Response) => {
    const { text } = req.body;
  ...
  router.get('/parser/examples', asyncHandler(async (req: TenantRequest, res: Response) => {
    const examples = [
      {
        category: 'Expenses',
        examples: [
  ...
  router.get('/parser/stats/:companyId', asyncHandler(async (req: TenantRequest, res: Response) => {
  ...
  router.post('/parser/validate', asyncHandler(async (req: TenantRequest, res: Response) => {
    const { text } = req.body;
  ...
  // Get parsing history
  router.get('/parser/history/:companyId', asyncHandler(async (req: TenantRequest, res: Response) => {
    const { companyId } = req.params;
    const { tenantId } = req;
  ...
  router.post('/parser/export', asyncHandler(async (req: TenantRequest, res: Response) => {
  ...
  router.get('/parser/config', asyncHandler(async (req: TenantRequest, res: Response) => {
    const config = {
