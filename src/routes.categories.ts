...
export function mountCategoryRoutes(router: Router) {
  // Get all categories
  router.get('/categories', async (req: TenantRequest, res) => {
  ...
  // Get category by ID
  router.get('/categories/:id', async (req: TenantRequest, res) => {
    const { id } = req.params;
  ...
  // Create new category
  router.post('/categories', async (req: TenantRequest, res) => {
  ...
  // Update category
  router.put('/categories/:id', async (req: TenantRequest, res) => {
    const { id } = req.params;
  ...
  // Delete category
  router.delete('/categories/:id', async (req: TenantRequest, res) => {
    const { id } = req.params;
  ...
  router.get('/categories/hierarchy', async (req: TenantRequest, res) => {
    const companyId = String(req.query.companyId || '');
